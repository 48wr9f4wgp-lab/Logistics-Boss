export function bindInsightStabilityV2(sim) {
  ...
  // The DOM state is authoritative even if ui.js' private flag drifted.
  ...
  function update() {
    // main.js calls this after ui.render(). Correct any transient writes in the
    // same animation frame so Safari never paints a CONTRACT/CLOSE flicker.
